			...
			<div class="inner">
				<div class="container home">
					  <div class="padded_content">
							...
							<ol>
								<li>First you will need to request a translation request token.  You accomplish this by passing your API key to the <a href="/docs/v1/api/translation_requests#create" title="Translation Requests Create Documentation">translation requests -> create</a> url.  You will receive a response containing the new translation request token.</li>
								...
								<li>Once all of your audio files have been sent to the API,  you can poll the <a href="/docs/v1/api/clips#read_all" title="Clips Index Documentation">clips -> read all</a> url.  The server will respond with a variable <strong>ready_for_processing</strong>.  If it is set to <strong>YES</strong>,  then you are ready to process the final video.  <strong>Please verify all clips have been added.  The API does not know the total number of clips it is expecting.</strong></li>
